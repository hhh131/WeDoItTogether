...
class ProfileEditView: UIView {
    ...
    func addViews(){
        [profilePhotoImageView, cameraIconImageView, nameTextField, editPasswordButton].forEach { item in
            addSubview(item)
    ...
    func setLayoutConstraints(){
        ...
        //비밀번호 변경 버튼
        NSLayoutConstraint.activate([
            editPasswordButton.topAnchor.constraint(equalTo: nameTextField.bottomAnchor, constant: 20),
